...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.file_layout.sizePolicy().hasHeightForWidth())
        self.file_layout.setSizePolicy(sizePolicy)
...
"}")
        ...
        self.logo = QtWidgets.QLabel(self.file_layout)
        self.logo.setMinimumSize(QtCore.QSize(0, 50))
        self.logo.setMaximumSize(QtCore.QSize(166780, 50))
        self.logo.setText("")
        ...
        self.file_menu.addItem(spacerItem9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selected_project.setText(_translate("MainWindow", "Selected Project"))
